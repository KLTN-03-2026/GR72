...
import { ThucDonMauEntity, ChiTietThucDonMauEntity } from '../../Nutritionist/MealTemplate/entities/thuc-don-mau.entity';
...
@Module({
  imports: [TypeOrmModule.forFeature([ThucDonMauEntity, ChiTietThucDonMauEntity])],
