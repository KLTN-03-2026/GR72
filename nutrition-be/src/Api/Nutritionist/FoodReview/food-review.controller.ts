...
export class NutritionistFoodReviewController {
  ...
  async findAll(
    ...
    return {
      success: true,
      data: { items, pagination: { page: p, limit: l, total } },
    };
  }
      ...
      data: {
        ...
        thuc_pham: entity.thuc_pham
          ? {
              ...
              calories_100g: entity.thuc_pham.calories_100g
                ? Number(entity.thuc_pham.calories_100g)
                : null,
              protein_100g: entity.thuc_pham.protein_100g
                ? Number(entity.thuc_pham.protein_100g)
                : null,
              carb_100g: entity.thuc_pham.carb_100g
                ? Number(entity.thuc_pham.carb_100g)
                : null,
              fat_100g: entity.thuc_pham.fat_100g
                ? Number(entity.thuc_pham.fat_100g)
                : null,
