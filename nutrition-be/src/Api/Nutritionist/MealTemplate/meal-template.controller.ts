...
export class NutritionistMealTemplateController {
  ...
  async create(@Body() dto: CreateMealTemplateDto, @Req() req: any) {
    ...
    return {
      success: true,
      message: 'Tao thuc don mau thanh cong',
  ...
  async update(
    ...
    if (dto.trangThai !== undefined)
      entity.trang_thai = dto.trangThai as MealTemplateStatus;
    if (dto.loaiMucTieuPhuHop !== undefined)
      entity.loai_muc_tieu_phu_hop = (dto.loaiMucTieuPhuHop as any) ?? null;
    if (dto.caloriesMucTieu !== undefined)
      entity.calories_muc_tieu = dto.caloriesMucTieu ?? null;
    ...
    return {
      success: true,
      message: 'Cap nhat thuc don mau thanh cong',
      data: this.toPublic(result!),
    };
  }
  ...
  private toPublic(e: ThucDonMauEntity) {
    return {
      ...
      calories_muc_tieu: e.calories_muc_tieu
        ? Number(e.calories_muc_tieu)
        : null,
