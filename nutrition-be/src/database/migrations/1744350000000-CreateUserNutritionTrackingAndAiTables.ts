...
export class CreateUserNutritionTrackingAndAiTables1744350000000
      ...
      await queryRunner.createTable(
        new Table({
          ...
          columns: [
            ...
            { name: 'nguon_id', type: 'bigint', unsigned: true, isNullable: true },
      ...
      await queryRunner.createTable(
        new Table({
          ...
          columns: [
            ...
            { name: 'protein_g', type: 'decimal', precision: 10, scale: 2, default: 0 },
            { name: 'carb_g', type: 'decimal', precision: 10, scale: 2, default: 0 },
            { name: 'fat_g', type: 'decimal', precision: 10, scale: 2, default: 0 },
            { name: 'chat_xo_g', type: 'decimal', precision: 10, scale: 2, isNullable: true },
            { name: 'natri_mg', type: 'decimal', precision: 10, scale: 2, isNullable: true },
      ...
      await queryRunner.createTable(
        new Table({
          ...
          columns: [
            ...
            { name: 'tai_khoan_id', type: 'bigint', unsigned: true },
            { name: 'ngay', type: 'date' },
            { name: 'tong_calories', type: 'decimal', precision: 10, scale: 2, default: 0 },
            { name: 'tong_protein_g', type: 'decimal', precision: 10, scale: 2, default: 0 },
            { name: 'tong_carb_g', type: 'decimal', precision: 10, scale: 2, default: 0 },
            { name: 'tong_fat_g', type: 'decimal', precision: 10, scale: 2, default: 0 },
            { name: 'so_bua_da_ghi', type: 'smallint', unsigned: true, default: 0 },
            { name: 'tao_luc', type: 'datetime' },
            { name: 'cap_nhat_luc', type: 'datetime' },
          ],
          uniques: [
      ...
      await queryRunner.createTable(
        new Table({
          ...
          columns: [
            ...
            { name: 'tai_khoan_id', type: 'bigint', unsigned: true },
            { name: 'tieu_de', type: 'varchar', length: '191', isNullable: true },
            {
              name: 'trang_thai',
              type: 'enum',
            ...
            { name: 'mo_hinh_cuoi', type: 'varchar', length: '100', isNullable: true },
            { name: 'tong_token_cuoi', type: 'int', unsigned: true, isNullable: true },
      ...
      await queryRunner.createTable(
        new Table({
          ...
          columns: [
            ...
            { name: 'tai_khoan_id', type: 'bigint', unsigned: true },
            { name: 'phien_tu_van_ai_id', type: 'bigint', unsigned: true, isNullable: true },
            {
              name: 'trang_thai',
              type: 'enum',
            ...
            { name: 'muc_tieu_calories', type: 'decimal', precision: 10, scale: 2, isNullable: true },
            { name: 'muc_tieu_protein_g', type: 'decimal', precision: 10, scale: 2, isNullable: true },
            { name: 'muc_tieu_carb_g', type: 'decimal', precision: 10, scale: 2, isNullable: true },
            { name: 'muc_tieu_fat_g', type: 'decimal', precision: 10, scale: 2, isNullable: true },
            { name: 'canh_bao', type: 'json', isNullable: true },
            { name: 'ly_giai', type: 'text', isNullable: true },
            { name: 'du_lieu_khuyen_nghi', type: 'json' },
            { name: 'ke_hoach_an_da_ap_dung_id', type: 'bigint', unsigned: true, isNullable: true },
            { name: 'tao_luc', type: 'datetime' },
            { name: 'cap_nhat_luc', type: 'datetime' },
          ],
          indices: [
